...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('gUAUNLaR.deporteYCultura', {
    url: '/page40',
    views: {
      'side-menu21': {
        templateUrl: 'templates/deporteYCultura.html',
        controller: 'deporteYCulturaCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.reglamentoDeEstudiantes', {
    url: '/page37',
    views: {
      'side-menu21': {
        templateUrl: 'templates/reglamentoDeEstudiantes.html',
        controller: 'reglamentoDeEstudiantesCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.ofertaAcadMica', {
    url: '/page82',
    views: {
      'side-menu21': {
        templateUrl: 'templates/ofertaAcadMica.html',
        controller: 'ofertaAcadMicaCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.horariosCsAplicadas', {
    url: '/page182',
    views: {
      'side-menu21': {
        templateUrl: 'templates/horariosCsAplicadas.html',
        controller: 'horariosCsAplicadasCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.horariosCsExactas', {
    url: '/page183',
    views: {
      'side-menu21': {
        templateUrl: 'templates/horariosCsExactas.html',
        controller: 'horariosCsExactasCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.horariosCsHumanas', {
    url: '/page184',
    views: {
      'side-menu21': {
        templateUrl: 'templates/horariosCsHumanas.html',
        controller: 'horariosCsHumanasCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.horariosCsSociales', {
    url: '/page185',
    views: {
      'side-menu21': {
        templateUrl: 'templates/horariosCsSociales.html',
        controller: 'horariosCsSocialesCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.horariosCsDeLaSalud', {
    url: '/page186',
    views: {
      'side-menu21': {
        templateUrl: 'templates/horariosCsDeLaSalud.html',
        controller: 'horariosCsDeLaSaludCtrl'
      }
    }
  })
  ...
  .state('gUAUNLaR.expoCarreras', {
    url: '/page177',
    views: {
      'side-menu21': {
        templateUrl: 'templates/expoCarreras.html',
        controller: 'expoCarrerasCtrl'
      }
    }
  })

  .state('gUAUNLaR.calendarioDeIngreso', {
    url: '/page179',
    views: {
      'side-menu21': {
        templateUrl: 'templates/calendarioDeIngreso.html',
        controller: 'calendarioDeIngresoCtrl'
      }
    }
  })

  .state('gUAUNLaR.movilidadEstudiantil', {
    url: '/page180',
    views: {
      'side-menu21': {
        templateUrl: 'templates/movilidadEstudiantil.html',
        controller: 'movilidadEstudiantilCtrl'
      }
    }
  })

  .state('gUAUNLaR.horariosDeClases', {
    url: '/page181',
    views: {
      'side-menu21': {
        templateUrl: 'templates/horariosDeClases.html',
        controller: 'horariosDeClasesCtrl'
      }
    }
  })
